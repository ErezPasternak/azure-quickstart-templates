<#
.Synopsis
Deploy a RDSH server for Applications as part of Ericom Connect 
...
function Download-RDSHAppsAgent()
{

	New-Item -Path "C:\Download-RDSHAppsAgent" -ItemType Directory -Force -ErrorAction SilentlyContinue
	Write-Output "Download-RDSHAppsAgent  -- Start"
	...
	Write-Output "Download-RDSHAppsAgent  -- End"
}

function Install-RDSHAppsAgent()
{
	New-Item -Path "C:\Install-RDSHAppsAgent" -ItemType Directory -Force -ErrorAction SilentlyContinue
...
function SendAdminMail ()
{
	...
	$Subject = "Ericom Connect RDSH Apps Deployment on " + (hostname) + " is now Ready"
...
function SendErrorMail ()
{
	...
	$Subject = "Ericom Connect RDSH Apps Deployment have failed on " + (hostname)	
...
function SendStartMail ()
{
	...
	$Subject = "Ericom Connect RDSH Apps Deployment on " + (hostname) +" have started"
